<nav class="modulos">
    ...
    <div class="modulo verde-escuro">
        <h3> Módulo 06 - Estruturas Repetição</h3>
        <ul>
            <li>
    ...
    <div class="modulo verde">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=tratamento_erro&file=desafio_indiv">
                    Desafio Indiv
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=tratamento_erro&file=desafio_indiv2">
                    Desafio Indiv #SolucaoOficial
                </a>
            </li>
            <li>
    ...
    <div class="modulo laranja">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=db&file=deletar_pdo">
                     PDO: Deletar
                </a>
            </li>
            <li>
